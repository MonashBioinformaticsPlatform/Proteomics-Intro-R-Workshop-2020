...
text <- c("```{r}",
          "library(tidyverse)",
          "geo <- readr::read_csv('r-intro-2-files/geo.csv')",
...
```{r echo=FALSE, comment=""}
text <- c("```{r echo = FALSE, fig.align = 'right', warning=FALSE}",
           "ggplot(gap_geo, aes(x=year, y=life_exp, group=name, color=region)) +",
           "geom_line()",
           "```")
cat(text, sep = "\n")
...
```{r echo=FALSE, comment=""}
text <- c("```{r echo = FALSE, fig.align = 'center', warning=FALSE, fig.height=6, fig.width=6}",
           "ggplot(gap_geo, aes(x=year, y=life_exp, group=name, color=region)) +",
           "geom_line()",
           "```")
cat(text, sep = "\n")
...
```{r echo=FALSE, comment=""}
text <- c("```{r echo = FALSE, fig.align = 'center', warning=FALSE, fig.height=6, fig.width=6, fig.cap='This figure illustrates  the life expectancy from 1800 to 2000 by region.'}",
           "ggplot(gap_geo, aes(x=year, y=life_exp, group=name, color=region)) +",
           "geom_line()",
           "```")
cat(text, sep = "\n")
